...
import LCILogo from "../../assets/svgs/LCI-logo.svg?react";
...
export default function LegionHeroHeader() {
  ...
  const handleValidateConfiguration = () => {
    navigate(Routes.EngineeringValidationCenter.path);
  };
  const handleDeployToLive = () => {
    if (hasBlockingErrors) {
      navigate(Routes.EngineeringValidationCenter.path, { fromDeploy: true });
    } else {
      navigate(Routes.EngineeringDeployment.path);
    }
  };
